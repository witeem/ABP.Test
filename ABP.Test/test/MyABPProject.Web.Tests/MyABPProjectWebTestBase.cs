...
{
    public abstract class MyABPProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyABPProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyABPProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyABPProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyABPProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyABPProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyABPProjectDbContext, Task<T>> func)
        {
            T result;
